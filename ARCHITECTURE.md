...
- `Nudge/Views/Tabs/SettingsTabView.swift` — Edits `UserProfile`; changes reach the arbiter via `ContentView.notificationToken`. Hosts the DEBUG sections (Dev notes, classifier harness).
