...
**Status:** awaiting first plan
**Cycle ID:** —

> This file holds **one** work item: the current one. The planner overwrites it
...
> [`README.md`](README.md).
>
> The template below is the shape a usable instruction takes. Replace it
> wholesale — don't leave the guidance text in a real plan.
